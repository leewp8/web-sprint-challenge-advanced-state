    ...
    <div id="wrapper">
      {
        ...
        quiz ? (
          <>
            ...
            <button id="submitAnswerBtn" onClick={handleSubmit} disabled={selectedAnswer?.answer_id === quiz.answers[0].answer_id || selectedAnswer?.answer_id === quiz.answers[1].answer_id? false: true} >Submit answer</button> 
          </>
        ) : 'Loading next quiz...'
      }
    </div>
